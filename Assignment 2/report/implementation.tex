%!TEX root = report.tex
The implementation in MATLAB of the Minover algorithm is fairly straightforward.
...
% The Minover algorithm can be implemented using the following pseudocode:
