...
\begin{abstract}
\noindent Aside from storing data, a perceptron can also be trained to learn a new rule. In this case a teacher perceptron has separated data and a student perceptron must learn the rule. To learn this rule, we have modified our solution of assignment 1 to implement the Min-Over algorithm. Using this algorithm, a student perceptron can successfully learn a rule from a teacher perceptron. We have also determined the generalization error which determines the probability of disagreement between student and teacher for an arbitrary dataset. 
\end{abstract}
